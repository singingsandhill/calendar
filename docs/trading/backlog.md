...
> [v2 마이그레이션 계획](bithumb-v2-migration-plan.md)(단계·게이트·안전요구),
> [세션 인계](v2-migration-handoff.md)(§6 스윕 상세 설계, §7 테스트 패턴).
...
- **방법:** `docs/guides/git-commit.md` Section T 의 Commit 65/66/67 `git add`+`git commit` 그대로 실행.
